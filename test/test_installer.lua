...
local function test_installer_module()
  ...
  assert(type(installer.check_installation) == "function", "check_installation function should exist")
  ...
  assert(type(installer.refresh_font_cache) == "function", "refresh_font_cache function should exist")
  assert(type(installer.get_latest_release) == "function", "get_latest_release function should exist")
...
local function test_installer_get_install_path()
  ...
  assert(path:match("C:\\Windows\\Fonts") or path:match("C:/Windows/Fonts"), "should return correct Windows path")
...
local function test_installer_get_latest_release()
  ...
  assert(release.download_url == "https://example.com/monaspace.zip", "should parse download_url correctly")
