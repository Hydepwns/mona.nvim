...
local function test_terminal_configs()
  ...
  assert(alacritty_config:match("normal = { family ="), "alacritty config should contain normal font")
  assert(alacritty_config:match("bold = { family ="), "alacritty config should contain bold font")
  assert(alacritty_config:match("italic = { family ="), "alacritty config should contain italic font")
  assert(alacritty_config:match("bold_italic = { family ="), "alacritty config should contain bold_italic font")
  ...
  assert(wezterm_config:match("font = wezterm%.font_with_fallback"), "wezterm config should contain font_with_fallback")
  ...
  assert(ghostty_config:match("font%-family%-bold ="), "ghostty config should contain font-family-bold")
  assert(ghostty_config:match("font%-family%-italic ="), "ghostty config should contain font-family-italic")
  assert(ghostty_config:match("font%-family%-bold%-italic ="), "ghostty config should contain font-family-bold-italic")
...
local function test_terminal_get_default_paths()
  ...
  -- Test path format
  assert(paths.alacritty:match("/%.config/alacritty/"), "alacritty path should contain .config/alacritty")
